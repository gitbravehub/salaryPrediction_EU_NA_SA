...
@st.cache_data
def load_model():
    pipeline = load('best_model_NA.joblib')
    return pipeline

pipeline_NA = load_model()

# Define the Streamlit page
def show_predict_page_north():
    st.markdown("<h1 style='text-align: center; color: red;'>Salary Prediction in North America for Software Engineers</h1>", unsafe_allow_html=True)
...
# Run the prediction page function
    ...
    def load_data():
        df = pd.read_csv("north_america.csv")
    ...
    st.markdown("<h2 style='text-align: center;';>Continue exploring about the salary landscape in North America for Software Engineers</h2>", unsafe_allow_html=True)
    ...
    st.write("""#### % of the Data surveyed from different countries in North America""")
    ...
    st.write("""#### Number of Data from different countries in North America""")
    # st.pyplot(fig1)
    ...
    st.write("#### Mean Salary Based On Experience in North America")
    ...
    st.write("#### Correlation Heatmap of features for Salary Prediction in North America")
     
         
    # Load your data
    north_america_df = pd.read_csv('north_america.csv')
    ...
    df_features = north_america_df[features]
    ...
    # # Plotting the heatmap with Streamlit
    ...
    # plt.title('Correlation of features for Salary Prediction in North America')
